    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className={cn('flex flex-col gap-6', className)} {...props}>
        ...
        <div className="grid gap-6">
          ...
          <RoodxInput forgotPassword control={form.control} id="password" name="password" label={t('input.password')} type="password" placeholder={t('input.placeholder.password')} />
